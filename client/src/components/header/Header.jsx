...
const Header = () => {
  ...
  return (
    <header ref={headerRef}>
      {/* black bar */}
      <nav
        className="container px-4 md:px-[50px] bg-black"
        // onMouseLeave={closeDropdown}
      >
        <div className="flex flex-col items-center justify-between w-full gap-3 md:gap-14 md:flex-row sm:flex-row lg:flex-row">
          {/* primary div */}
          <div className=" sm:h-[100px] md:h-[60px] lg:h-[30px] flex items-center justify-between w-[100%] max-w-[650px]">
            {/* what to put here */}
          </div>
      ...
      {/* white space bar */}
      <nav
        className="container px-4 md:px-[50px] bg-white"
        // onMouseLeave={closeDropdown}
      >
        <div className="flex flex-col items-center justify-between w-full gap-3 md:gap-14 md:flex-row sm:flex-row lg:flex-row">
          {/* primary div */}
          <div className=" sm:h-[100px] md:h-[60px] lg:h-[10px] flex items-center justify-between w-[100%] max-w-[650px]">
            {/* what to put here */}
          </div>
      ...
      >
        <div className="flex flex-col items-center justify-between w-full gap-3 md:gap-14 md:flex-row sm:flex-row lg:flex-row">
          ...
          {/* secondary div */}
          <div className="flex items-center justify-between gap-[10px] w-[30%] mb-4 md:mb-0">
            {/* home */}
            <div className="flex items-center group">
              {/* <NavLink to="/" className="flex items-center gap-1">
                                <BiHomeSmile className="text-[22px]" />
            ...
            <div
              className={`flex items-center relative cursor-pointer group ${
                auth.user ? "hover:bg-slate-100" : "hover:bg-black"
              }  p-1`}
            ...
            >
              ...
              {isDropdownOpen && (
                <div
                  className="absolute top-[36px] -left-[2px] z-50 bg-white shadow-md p-2 w-[140px] uppercase transition-all flex flex-col "
                  onMouseEnter={toggleDropdown}
                  onMouseLeave={closeDropdown}
                >
                  <ul>
